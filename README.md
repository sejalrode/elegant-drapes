...
- Manual source name entry on each order, with suggestions from past sources
...
Source groups are optional. Orders store the typed source name directly, and reports group profit by that source name.
